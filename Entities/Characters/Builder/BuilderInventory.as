...
void onInit(CInventory@ this)
{
	...
	// blob.RemoveScript("CommonBuilderBlocks.as");
	// blob.AddScript("CommonBuilderBlocks2.as");
	
	// }
	// if(blob.getTeamNum() == 0)
	// {
	
	// blob.RemoveScript("CommonBuilderBlocks2.as");
	// blob.AddScript("CommonBuilderBlocks.as");

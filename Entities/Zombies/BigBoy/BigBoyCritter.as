...
void onInit(CBlob@ this)
{
	...
	vars.walkForce.Set(18,0.0f);
	vars.runForce.Set(30,0.0f);
	vars.slowForce.Set(difficulty*4.0f,0.5f);
	vars.jumpForce.Set(0.0f,-150.0f);
...
void onTick( CMovement@ this )
{
	...
	//if (left || right)
	{
		...
		if ((blob.isOnGround() || blob.isInWater()) && up)
		{ 
			f32 mod = blob.isInWater() ? 0.23f : 1.0f;
			blob.AddForce(Vec2f( mod*vars.jumpForce.x, vars.jumpForce.y));
		}
	}

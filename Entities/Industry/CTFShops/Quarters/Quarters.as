...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$musicbox$", "MusicBox.png", Vec2f(32, 16), 0);
	...
	{
		ShopItem@ s = addShopItem(this, "MusicBox", "$musicbox$", "musicbox", "Plays Beats.", true);
		AddRequirement(s.requirements, "coin", "", "Coins", 0);
		AddRequirement( s.requirements, "no more", "musicbox", "MusicBox", 1 );
	}
}

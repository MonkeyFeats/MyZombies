...
void onInit(CBlob@ this)
{
	...
	if (getNet().isServer())
	{
		CBlob@ mig = server_CreateBlob("migrant", this.getTeamNum(), this.getPosition()+Vec2f(0,-50));
		if (mig !is null)
		{
        //	AttachmentPoint@ parapoint = mig.getAttachments().getAttachmentPointByName("PARACHUTE");
        //	if (parapoint !is null)
        //	{
		//		CBlob@ chute = server_CreateBlob("parachute", XORRandom(8), this.getPosition()+Vec2f(0,-50));
		//		if (chute !is null)			
		//		{
		//			mig.server_AttachTo(chute, parapoint);					
		//		}
		//	}
		}        
	}

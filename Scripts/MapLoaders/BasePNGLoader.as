...
class PNGLoader
{
	...
	void SetupBackgrounds()
	{
		...
		map.AddBackground( "Sprites/Back/BackgroundPlains.png", Vec2f(0.0f, 0.0f), Vec2f(0.01f, 0.0f), color_white ); 
		map.AddBackground( "Sprites/Back/BackgroundTrees.png", Vec2f(0.0f,  0.0f), Vec2f(0.12f, 0.0f), color_white ); 
		//map.AddBackground( "Sprites/Back/BackgroundIsland.png", Vec2f(0.0f, 50.0f), Vec2f(0.5f, 0.5f), color_white ); 
		map.AddBackground( "Sprites/Back/BackgroundCastle.png", Vec2f(50.0f, 10.0f), Vec2f(0.35f, 0.0f), color_white ); 
